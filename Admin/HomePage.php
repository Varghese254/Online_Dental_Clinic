...
<body>
        ...
        <div class="row gx-0">
            <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <small class="py-2"><i class="far fa-clock text-primary me-2"></i>Opening Hours: Mon - Tues : 8.00 am - 9.00 pm, Sunday Closed </small>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
            ...
            <h1 class="m-0 text-primary"><i class="fa fa-tooth me-2"></i>Aami DentalCare</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="nav-item dropdown">
              <div class="dropdown-menu m-0">
                ...
                <div class="nav-item dropdown">
                  <a href="" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> Dentist</a>
                  <div class="dropdown-menu m-0">
                  <a href="DentistType.php".php" class="dropdown-item">Dentist Type</a>
                      <a href="NewDentist.php".php" class="dropdown-item">Add Dentist</a>
                      <a href="DentistList.php" class="dropdown-item">Schedule Dentist</a>
                      <a href="ActiveDentistList.php".php" class="dropdown-item">Active Dentist</a>
                   <a href="InactiveDentist.php".php" class="dropdown-item">Inactive Dentist</a> 
                  </div>
              ...
              <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu m-0">
                  <a href="pie.php" class="dropdown-item">Product Sales</a>
                      <a href="RequestReport.php" class="dropdown-item">Appointment</a>
                      <a href="SalesFrom.php" class="dropdown-item">From-Sales-To</a>
                       <a href="bar.php" class="dropdown-item">Service Rating</a>
                ...
                <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu m-0">
                  <a href="Category.php".php" class="dropdown-item">Add Category</a>
                      <a href="Subcategory.php".php" class="dropdown-item">Add Subcategory</a>
                      <a href="Size.php" class="dropdown-item">Add Size</a>
                      <a href="Product.php".php" class="dropdown-item">Add Product</a>
                      <a href="ProductList.php".php" class="dropdown-item">Add Stock</a> 
               ...
               <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu m-0">
                  <a href="Userlist.php".php" class="dropdown-item">Patient List</a>
                      <a href="UserReview.php".php" class="dropdown-item">Reviews</a>
                      <a href="UserComplaint.php" class="dropdown-item">Complaints</a>
                      <a href="SolvedComplaints.php".php" class="dropdown-item">Solved Complaints</a>
                  <a href="PayedList.php" class="dropdown-item">Payed List Of Products</a>
                   <a href="PayedDoc.php" class="dropdown-item">Payed Appointments</a>
                  </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                       ...
                       <img src="../Assets/Template/Main/img/1662896447060.jpg" width="50%" alt="Image" >
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">WELCOME VARGHESE</h5>
                          
                           <!--  <h1 class="display-1 text-white mb-md-4 animated zoomIn">Have a good day</h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
                   ...
                   <div align="center">
                   <a href="../Admin/District.php" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Add Districts</a>
                    <a href="../Admin/Orders.php" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Order</a>
                    <a href="../Admin/Place.php" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Add Place</a>
                    
                     <a href="../Admin/ServiceList.php" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Add More Services</a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 wow zoomIn" data-wow-delay="0.6s">
                    <div class="offer-text text-center rounded p-5">
                        ...
                        <a href="../User/Cartlist.php" class="btn btn-dark py-3 px-5 me-3">My Cart</a>
                        <a href="../User/PayedList.php" class="btn btn-light py-3 px-5">Product buyed</a>
                    </div>
                </div>
            </div>
        </div>
 ...
 <div class="container-fluid bg-dark text-light py-5 wow fadeInUp" data-wow-delay="0.3s" style="margin-top: -75px;">
        <div class="container pt-5">
            <div class="row g-5 pt-4">
                <div class="col-lg-3 col-md-6">
                   <!-- <h3 class="text-white mb-4">Quick Links</h3>
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-light mb-2" href="../Assets/Template/Main/#"><i class="bi bi-arrow-right text-primary me-2"></i>Home</a>
                        <a class="text-light mb-2" href="../Assets/Template/Main/#"><i class="bi bi-arrow-right text-primary me-2"></i>About Us</a>
                ...
                <div class="col-lg-3 col-md-6">
                 <!-- <div class="d-flex">
                    <a class="btn btn-lg btn-primary btn-lg-square rounded me-2" href="../Assets/Template/Main/#"><i class="fab fa-twitter fw-normal"></i></a>
                    <a class="btn btn-lg btn-primary btn-lg-square rounded me-2" href="../Assets/Template/Main/#"><i class="fab fa-facebook-f fw-normal"></i></a>
                    <a class="btn btn-lg btn-primary btn-lg-square rounded me-2" href="../Assets/Template/Main/#"><i class="fab fa-linkedin-in fw-normal"></i></a>
                    <a class="btn btn-lg btn-primary btn-lg-square rounded" href="../Assets/Template/Main/#"><i class="fab fa-instagram fw-normal"></i></a>
                    </div>-->
              </div>
            </div>
        </div>
