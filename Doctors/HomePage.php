...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
       ...
       <a href="../Guest/Login.php" class="nav-item nav-link active">Logout</a>
    ...
    border-radius: 50%;"><?php echo $result["coun"] ?></span> PatientRequest </a>
                       <a href="Patientpatients.php" class="dropdown-item">AcceptedRequest</a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Assets/Template/Main/img/price-3.jpg" alt="Image">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img src="../Assets/Template/Main/img/1662954240177.jpg" class="position-absolute w-100 h-100 rounded wow zoomIn" style="object-fit: cover;" data-wow-delay="0.9s">
                    </div>
                </div>
            </div>
        </div>
