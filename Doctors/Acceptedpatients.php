...
include("Head.php");
  ...
  $selqry="select * from tbl_appointmentrequest u inner join tbl_user p on u.user_id=p.user_id inner join tbl_service x on u.service_id=x.service_id where u.dentist_id='".$_SESSION['uid']."' and appointment_status=1";
  ...
  while($result=$row->fetch_assoc())
  {
    ...
    <tr>
      ...
      <td><img src="../Assets/Files/UserPhoto/<?php echo $result["user_photo"];?>"width="120" height="120"/></td>
         <td><a href="Prescription.php?did=<?php echo $result["user_id"]?>&user=<?php echo $result["user_email"]?>&name=<?php echo $result["user_name"]?>">Prescribe</a></td> </tr> 
