...
$selqry="select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_product p on p.product_id=c.product_id where booking_status=2 and cart_status=1 and  user_id='".$_SESSION["lgid"]."'";
...
<form id="form1" name="form1" method="post" action="">
  ...
  <tr>
          ...
          <td><a href="bill.php?bid=<?php echo $row["booking_id"] ?>">Download</a></td>
 <td>  <a href="ProductReview.php?pid=<?php echo $row["product_id"]?>">Review</a></td>
  </tr>
  <?php
	}
	?>
