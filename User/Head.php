    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="nav-item dropdown">
               ...
               </h1> <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu m-0">
                      <a href="DentistList.php".php" class="dropdown-item">DentistList</a>
                        <a href="ActiveDentists.php".php" class="dropdown-item">Active Dentist</a>
                        
                                        </div>
                                       
              </div>
              </h1> </h1> <a href="SearchProduct.php" class="nav-item nav-link">Search Product</a>
