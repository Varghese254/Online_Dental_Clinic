...
?>
    ...
    <?php
        if (isset($_POST["btn_checkout"])) {
                ...
                $selC = "select * from tbl_booking where user_id='" .$_SESSION["lgid"]. "'and booking_status='0'";
                $rs = $con->query($selC);
                $row=$rs->fetch_assoc();
    ...
    <body onload="recalculateCart()">
        <h1>Cart</h1>
            <div class="column-labels">
                ...
                <label class="product-price" style="width: 15%; text-align:center">Product</label>
                ...
                <label class="product-price" style="width: 20%; text-align:center">Remove</label>
        ...
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
            ...
            <div class="product">
                <div class="product-image">
                    <img
                        src="../Assets/Files/ProductPhoto/<?php echo $rowpr["product_image"] ?>"
                        />
                </div>
                ...
                <div class="product-quantity">
                    <input alt="<?php echo $row["cart_id"] ?>" type="number" value="<?php echo $row["cart_qty"] ?>" min="1" max="<?php echo $rowst["stock"] ?>"/>
                </div>
