                ...
                <div class="form">
                    <form method="post">
                        <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" placeholder="Card Holder"  required="required"  onchange="nameval(this)" autocomplete="off" pattern="^[A-Z]+[a-zA-Z ]*$" />
