...
?>
    ...
    include("../Assets/Connection/connection.php");
				...
				{	
							...
							$upQry="update tbl_appointmentrequest set appointment_status='3' where appointment_id='".$_GET["bid"]."'";
	 						if($con->query($upQry))
	 							{
									?>
                                    <script>
                                    alert('Payment Completed');
                                    window.location="RequestStatus.php";
                                    </script>
                                    <?php
								}
                ...
                <div class="form">
                    <form method="post">
                        <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" placeholder="Card Holder"  required="required"  pattern="^[A-Z]+[a-zA-Z ]*$" >
                            <i class="fas fa-user"></i>
                        </div>
                        <div class="card space icon-relative">
                            <label class="label">Card number:</label>
                            <input type="text" class="input" data-mask="0000 0000 0000 0000" placeholder="Card Number"  required="required">
